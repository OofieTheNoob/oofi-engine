...
class MainMenuState extends MusicBeatState
{
	...
	public static var oofieEngineVersion:String = '0.1'; 
	...
	override function create()
	{
		...
		//FlxTween.tween(checker, {angle: 45}, 1, {ease: FlxEase.quartInOut});
		//FlxTween.tween(magenta, {angle: 0}, 1, {ease: FlxEase.quartInOut});

		FlxG.camera.follow(camFollowPos, null, 1);

		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Oofie Engine v" + oofieEngineVersion, 12);
				...
				else
				{
					...
					menuItems.forEach(function(spr:FlxSprite)
					{
						if (curSelected != spr.ID)
						{
							...
							FlxTween.tween(checker, {alpha: 0}, 0.8, {ease: FlxEase.expoIn});
							/*FlxTween.tween(checkerColor, {angle: 45}, 0.8, {ease: FlxEase.expoIn});
							FlxTween.tween(checkerColor, {alpha: 0}, 0.8, {ease: FlxEase.expoIn});*/
